 ...
 *
 */
public class Scratch2EmulatorFactory implements EmulatorFactory{
	 ...
	 * @param factory
	 */
	public Scratch2EmulatorFactory(ScratchRuntimeFactory factory) {
	...
	public String getEmulatorIdentifier() {
		return "Scratch 2 reference implementation.";
	}
	...
	public Emulator createEmulator(File projectFile) throws IOException {
		return new Scratch2Emulator(factory.createScratchRuntime(projectFile));
	}
	...
	public Emulator createEmulator(File projectFile, HashMap<String, Object> parameters) throws IOException {
		...
		return new Scratch2Emulator(factory.createScratchRuntime(projectFile,stageWidth,stageHeight));
	}
